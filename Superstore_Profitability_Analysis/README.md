...
We developed an interactive **Power BI report** to complement the Python analysis and to visualize profitability patterns dynamically.

### Dashboard Pages
1. **Profitability Overview** – overall sales, profit, and average profit margin by product category and sub-category.  
2. **Discount Impact** –  discount levels' impact on profit margins and identification of loss thresholds.  
